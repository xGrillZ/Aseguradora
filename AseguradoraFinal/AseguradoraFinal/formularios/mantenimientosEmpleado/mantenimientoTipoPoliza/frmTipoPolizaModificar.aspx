         ...
         <form id="frmTipoPolizaModifica" runat="server" class="form-inline">      
              <h1 class="auto-style1">Mantenimiento Tipo Póliza - Modificar</h1>       
               ...
               <div class="form-group">
                   ...
                   <asp:RequiredFieldValidator ID="rqVddl_NombreTipoPoliza" runat="server" ErrorMessage="Debes de agregar un nombre de póliza" ControlToValidate="ddl_NombreTipoPoliza" Display="None"></asp:RequiredFieldValidator>
