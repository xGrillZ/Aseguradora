<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/AseguradoraPagMaestra.Master" AutoEventWireup="true" CodeBehind="frmClientesElimina.aspx.cs" Inherits="AseguradoraFinal.formularios.mantenimientosEmpleado.mantenimientoClientes.frmClientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="/css/global.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <section class="clientes-Elimina">
        <div class="contenido-principal">
            <form id="frmClienteElimina" runat="server" class="form-inline">      
              <h1 class="auto-style1">Eliminación clientes.</h1>       

               <div class="form-group">
                  <asp:Label ID="Label3" runat="server" Text="Nombre cliente:"></asp:Label>      
                  <asp:TextBox ID="txtNombreCliente" runat="server" class="form-control" Enabled="False"></asp:TextBox>
               ...
               <div class="form-group">
                   ...
                   <asp:TextBox ID="txtPriApellido" runat="server" class="form-control" Enabled="False"></asp:TextBox>
               ...
               <div class="form-group">
                    <asp:Label ID="Label5" runat="server" Text="Segundo apellido:"></asp:Label>
                     <asp:TextBox ID="txtSegApellido" runat="server" class="form-control" Enabled="False"></asp:TextBox>
               ...
               <div class="form-group">
                  ...
                  <asp:TextBox ID="txtNumCedula" runat="server" class="form-control" Enabled="False"></asp:TextBox>
               ...
               <div class="form-group">
                  ...
                  <asp:TextBox ID="txtGenero" runat="server" class="form-control" Enabled="False"></asp:TextBox>
                ...
                <div class="form-group">
                  ...
                  <asp:TextBox ID="txtDireccionFisica" runat="server" class="form-control" Enabled="False"></asp:TextBox>
               ...
               <div class="form-group">
                  ...
                  <asp:TextBox ID="txtPriTelefono" runat="server" class="form-control" Enabled="False"></asp:TextBox>
               ...
               <div class="form-group">
                  ...
                  <asp:TextBox ID="txtSegTelefono" runat="server" class="form-control" Enabled="False"></asp:TextBox>
              ...
              <br />
              <asp:ValidationSummary ID="vsModificaCliente" runat="server" ShowMessageBox="True" ShowSummary="False" />
            </form>
        </div>
    </section>
</asp:Content>
