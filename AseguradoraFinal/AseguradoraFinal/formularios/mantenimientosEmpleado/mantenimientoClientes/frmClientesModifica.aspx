<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/AseguradoraPagMaestra.Master" AutoEventWireup="true" CodeBehind="frmClientesModifica.aspx.cs" Inherits="AseguradoraFinal.formularios.mantenimientosEmpleado.mantenimientoClientes.frmClientesModifica" %>
    ...
    <form id="frmClienteModifica" runat="server" class="form-inline">      
      <h1 class="auto-style1">Actualizar datos de Asegurado</h1>       
       ...
       <div class="form-group">
           ...
           <asp:HyperLink ID="hpRegresar" runat="server" CssClass="text-info" NavigateUrl="~/formularios/mantenimientoClientes/frmClientesLista.aspx">Regresar a la lista</asp:HyperLink>
       </div>             
